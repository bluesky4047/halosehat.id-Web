    <nav class="bg-gray-800" x-data="{ isOpen: false }">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/readarticle" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('readarticle') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}}">Article</a>
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div x-show="isOpen"
                    ...
                    <a href="/signUp" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Register</a>
                    <a href="/signIn" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Login</a>
        ...
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <a href="/readarticle" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Article</a>
